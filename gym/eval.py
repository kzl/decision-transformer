...
def experiment(
    ...
    variant["para_path"] = r"saved_para/%s/%s/%s/" % (variant["env"], variant["dataset"], variant["mode"])
    ...
    max_file_name = sorted(file_names,key=lambda x:len(x),reverse=True)
    max_file_name = "iter_10.pt"
    para_path = variant["para_path"] + max_file_name
...
if __name__ == '__main__':
    ...
    parser.add_argument('--para_path', '-w', type=str, default="saved_para/hopper/")
